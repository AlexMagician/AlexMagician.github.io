                        ...
                        a: do {
                            ...
                            if (!(k = n.$$watchersCount && n.$$childHead || n !== this && n.$$nextSibling))
                                for (; n !== this && !(k = n.$$nextSibling); )
                                    n = n.$parent
                        } while (n = k);if ((s || u.length) && !t--)
                            throw p.$$phase = null,
                            c("infdig", a, w);
                    } while (s || u.length);for (p.$$phase = null; x.length; )
                        try {
                            x.shift()()
                        } catch (z) {
                            g(z)
                    ...
                    a.$watchCollection(q, function(g) {
                        ...
                        for (k = 0; k < F; k++)
                            ...
                            I.scope) {
                                ...
                                do
                                    B = B.nextSibling;
                                while (B && B.$$NG_REMOVED);I.clone[0] != B && c.move(qb(I.clone), null, z(w));
...
!function(a, b) {
    ...
    function b(b) {
        return function() {
            ...
            this.setKeyPrefix = function(a) {
                if ("string" != typeof a)
                    throw new TypeError("[ngStorage] - " + b + "Provider.setKeyPrefix() expects a String.");
                c = a
            }
            ;
            var d = a.toJson
            ...
            this.setSerializer = function(a) {
                if ("function" != typeof a)
                    throw new TypeError("[ngStorage] - " + b + "Provider.setSerializer expects a function.");
                d = a
            }
            ,
            this.setDeserializer = function(a) {
                if ("function" != typeof a)
                    throw new TypeError("[ngStorage] - " + b + "Provider.setDeserializer expects a function.");
                e = a
            }
            ,
            this.get = function(a) {
            ...
            this.$get = ["$rootScope", "$window", "$log", "$timeout", function(f, g, h, i) {
                ...
                var k, l, m = c.length, n = j(b) || (h.warn("This browser does not support Web Storage!"),
                {
                    ...
                    $default: function(b) {
                        for (var c in b)
                            a.isDefined(o[c]) || (o[c] = b[c]);
                        return o.$sync(),
                        o
                    },
                    $reset: function(a) {
                        for (var b in o)
                            "$" === b[0] || delete o[b] && n.removeItem(c + b);
                        return o.$default(a)
                    },
                    $sync: function() {
                        for (var a, b = 0, d = n.length; d > b; b++)
                            (a = n.key(b)) && c === a.slice(0, m) && (o[a.slice(m)] = e(n.getItem(a)))
                    },
                    $apply: function() {
                        var b;
                        if (l = null,
                        !a.equals(o, k)) {
                            b = a.copy(k),
                            a.forEach(o, function(e, f) {
                                a.isDefined(e) && "$" !== f[0] && (n.setItem(c + f, d(e)),
                                delete b[f])
                            });
                            for (var e in b)
                                n.removeItem(c + e);
    ...
    return a = a && a.module ? a : window.angular,
    a.module("ngStorage", []).provider("$localStorage", b("localStorage")).provider("$sessionStorage", b("sessionStorage"))
});
(function(s) {
    var w, f = {}, o = window, l = console, m = Math, z = 'postMessage', p = 0, r = 'hasOwnProperty', y = [].slice, x = 'fail', v = Worker;
    function d() {
        do {
